...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <form action="kitap_ara_sonuc.php" method="get">
    ...
    <body>
        <br><br><br><h1>Yazar Güncelle</h1><br>
        <form action="guncellendi_yazar.php" method="post">
            Yazar Adı: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="<?php echo $satir["yazarAdi"] ;?>" name="yazarAdi"><br><br>
            Yazar Soyadı: &nbsp;<input type="text" value="<?php echo $satir["yazarSoyadi"] ;?>" name="yazarSoyadi"><br><br>
            Yazar Detay: &nbsp;&nbsp;<input type="text" value="<?php echo $satir["yazarAdres"] ;?>" name="yazarAdres"><br><br>
            <input type="hidden" value="<?php echo $satir["yazarNo"] ;?>" name="yazarNo"><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Kaydı Güncelle">
        </form>
   <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><footer class="altbilgi">
