<?php
    ...
    $sorgu = "INSERT INTO kategori (kategoriAdi)
            VALUES ('$kategoriAdi')";
...
<!-- KODLAR -->
<br><br><h1>Kategori İşlem Sonucu</h1><b><br></b>
<p><img src="insert.png" alt="resim" style="width:50px;"><br><?php echo $islemSonuc; ?></p><br>
<p><a href="kategori_ekle.php">Yeni Kategori Ekle</a></p>
    &nbsp;&nbsp;<p4><a href="kategori.php"><<<---Listeye geri dön</a></p4><br>
<?php
...
while($satir = mysqli_fetch_assoc($sorgu2)){
    ...
    echo("<td><a href='sil_kategori.php?kategoriNo=".$satir["kategorirNo"]."'>Sil</a></td>");
    echo("</tr>");
            }
echo("</table>");
?>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><footer class="altbilgi">
