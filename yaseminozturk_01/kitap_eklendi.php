<?php
    ...
    $sorgu = "INSERT INTO kitap (kitapAdi, yazarNo, yayineviNo, kategoriNo, kitapBasimYili, kitapBasimYer, kitapISBN, kitapAciklama, kitapSayfaSayisi, kitapAdet)
            VALUES ('$kitapAdi', '$yazarNo', '$yayineviNo', '$kategoriNo', '$kitapBasimYili', '$kitapBasimYer', '$kitapISBN', '$kitapAciklama', '$kitapSayfaSayisi', '$kitapAdet')";
...
<!-- KODLAR -->
<br><br><h1>Kitap İşlem Sonucu</h1><br>
<p><img src="insert.png" alt="resim" style="width:60px;"><br><?php echo $islemSonuc; ?></p><br>
<p><a href="kitap_ekle.php">Yeni Kitap Ekle!</a></p><br>
&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="kitap.php"><<<---Listeye geri dön</a><br><br>
<?php
