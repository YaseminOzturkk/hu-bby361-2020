<?php
    ...
    $silinecek = mysqli_real_escape_string($baglanti, $_GET["kitapNo"]);
    $sorgu = "DELETE FROM kitap WHERE kitapNo = '$silinecek'";
...
<p><img src="trash-bin.png" style="width:50px" margin-left="50px";><br><?php echo $islemSonuc; ?></p><br>
<a href="kitap.php"><<<---Listeye geri dön</a>
<!-- KODLAR -->   
</main>
