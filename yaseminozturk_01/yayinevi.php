...
<!-- KODLAR -->
<br><br><h1>Yayınevi Listesi</h1><br>
<p><a href="yayinevi_ekle.php">Yeni Yayınevi Ekle!</a></p><br><br>
<?php
echo("<table border=1 align=center width=80%>");
    ...
    echo("<td><b>Yayınevi E-posta</b></td>");
...
while($satir = mysqli_fetch_assoc($sorgu)){
    ...
    echo("<td><a href=".$satir['yayineviEposta']."target='_blank'>".$satir["yayineviEposta"]."</a></td>");
