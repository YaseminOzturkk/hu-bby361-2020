...
<!-- KODLAR -->
<br><br><br><h1>Yazar Ekle</h1><br>
<form action="yazar_eklendi.php" method="post">
    Yazar Adı:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="yazarAdi"><br><br>
    Yazar Soyadı: <input type="text" name="yazarSoyadi"><br><br>
    Yazar URL: <textarea name="yazarAdres"></textarea><br><br>
