<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yayinevi WHERE yayineviNo = $guncellenecek");
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <form action="kitap_ara_sonuc.php" method="get">
    ...
    <body>
        <br><br><br><h1>Yayınevi Güncelle</h1><br>
        <form action="guncellendi_yayinevi.php" method="post">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yayinevi Adı: <input type="text" value="<?php echo $satir["yayineviAdi"] ;?>" name="yayineviAdi"><br><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yayınevi Web Sitesi: <input type="text" value="<?php echo $satir["yayineviURL"] ;?>" name="yayineviURL"><br><br>
            Yayınevi Eposta Adresi: <input type="text" value="<?php echo $satir["yayineviEposta"] ;?>" name="yayineviEposta"><br><br>
            <input type="hidden" value="<?php echo $satir["yayineviNo"] ;?>" name="yayineviNo">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Kaydı Güncelle">
        </form><br><br>
        
        <p><a href="yayinevi.php">--->>>Listeye geri dön</a></p>
   <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><footer class="altbilgi">
